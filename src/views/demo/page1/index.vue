  ...
  <div>
    ...
    <div class="content">
      <div class="d-block comment-body markdown-body  js-comment-body">
        ...
        <ol>
          <li>
            <p>数据结构和算法解决是 “如何让计算机更快时间、更省空间的解决问题”。</p>
          </li>
          <li>
            <p>因此需从执行时间和占用空间两个维度来评估数据结构和算法的性能。</p>
          </li>
          <li>
            <p>分别用时间复杂度和空间复杂度两个概念来描述性能问题，二者统称为复杂度。</p>
          </li>
          <li>
            <p>复杂度描述的是算法执行时间（或占用空间）与数据规模的增长关系。</p>
          </li>
        </ol>
        <h2>2. 为什么要进行复杂度分析 ？</h2>
        <ol>
          <li>
            <p>和性能测试相比，复杂度分析有不依赖执行环境、成本低、效率高、易操作、指导性强的特点。</p>
          </li>
          <li>
            <p>掌握复杂度分析，将能编写出性能更优的代码，有利于降低系统开发和维护成本。</p>
          </li>
        </ol>
        <h2>3. 如何进行复杂度分析 ？</h2>
        <h3>3.1 大 O 表示法</h3>
   ...
   for (; i &lt;= n; ++i) {  // n 次
     ...
     for (; j &lt;= n; ++j) {  // n * n ，也即是  n平方次
       sum = sum +  i * j;  // n * n ，也即是  n平方次
        ...
        <p>注意，这里是二层 for 循环，所以第二层执行的是 n * n = n<sup>2</sup> 次，而且这里的循环是 ++i，和例子 2 的是 i++，是不同的，是先加与后加的区别。</p>
...
function f(n) {
  ...
  return sum;
        ...
        <p>所以，整个 cal() 函数的时间复杂度就是，T(n) = T1(n) * T2(n) = O(n*n) = O(n<sup>2</sup>) 。</p>
        <ul>
          <li>
            <ol start="4">
...
while (i &lt;= n)  {
   i = i * 2;
        ...
        <p>因为对数之间是可以互相转换的，log3n = log<sub>3</sub>2 * log<sub>2</sub>n，所以 O(log<sub>3</sub>n) = O(C * log<sub>2</sub>n)，其中 C=log<sub>3</sub>2 是一个常量。</p>
   ...
   return sum;
    ...
    if (n &lt;= 1) {
        ...
        <p>参考答案：<br>
          ...
          显然 T(n) = T(n - 1) + T(n - 2) 是一个<a
            href="https://baike.baidu.com/item/%E6%96%90%E6%B3%A2%E9%82%A3%E5%A5%91%E6%95%B0%E5%88%97"
            rel="nofollow"
          >斐波那契数列</a>，通过归纳证明法可以证明，当 n &gt;= 1 时 T(n) &lt; (5/3)<sup>n</sup>，同时当 n &gt; 4 时 T(n) &gt;= (3/2)<sup>n</sup>。<br>
          所以该方法的时间复杂度可以表示为 O((5/3)<sup>n</sup>)，简化后为 O(2<sup>n</sup>)。<br>
          可见这个方法所需的运行时间是以指数的速度增长的。<br>
...
function find(array, n, x) {
  ...
  return pos;
        ...
        <p>所以上面代码的 <strong>最好情况时间复杂度</strong>为 O(1)，<strong>最坏情况时间复杂度</strong>为 O(n)。</p>
        ...
        <p><a
            ...
            href="https://camo.githubusercontent."
          ><img
              src="https://camo.githubusercontent."
              alt=""
              data-canonical-src="https://upload-images.jianshu.io/upload_images/12890819-d26874696f17beeb.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240"
              style="max-width:100%;"
            ></a></p>
        <p>省略掉系数、低阶、常量，所以，这个公式简化之后，得到的<strong>平均时间复杂度</strong>就是 O(n)。</p>
        ...
        <p><a
            target="_blank"
            rel="noopener noreferrer"
            href="https://camo.githubusercontent."
          ><img
              src="https://camo.githubusercontent."
              alt=""
              data-canonical-src="https://upload-images.jianshu.io/upload_images/12890819-bdc97cea949dff77.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240"
              style="max-width:100%;"
            ></a></p>
        <p>这个值就是概率论中的 <strong>加权平均值</strong>，也叫 <strong>期望值</strong>，所以平均时间复杂度的全称应该叫 <strong>加权平均时间复杂度</strong> 或者 <strong>期望时间复杂度</strong>。</p>
        <p>所以，根据上面结论推导出，得到的 <strong>平均时间复杂度</strong> 仍然是 O(n)。</p>
        ...
        <p><a
            target="_blank"
            rel="noopener noreferrer"
            href="https://camo.githubusercontent."
          ><img
              src="https://camo.githubusercontent."
              alt=""
              data-canonical-src="https://upload-images.jianshu.io/upload_images/12890819-0fbba76f829055ff.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240"
              style="max-width:100%;"
            ></a></p>
        <p><a
            target="_blank"
            rel="noopener noreferrer"
            href="https://camo.githubusercontent."
          ><img
              src="https://camo.githubusercontent."
              alt=""
              data-canonical-src="https://upload-images.jianshu.io/upload_images/12890819-682a810f1a8ecb55.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240"
              style="max-width:100%;"
            ></a></p>
        <p><a
            target="_blank"
            rel="noopener noreferrer"
            href="https://camo.githubusercontent."
          ><img
              src="https://camo.githubusercontent."
              alt=""
              data-canonical-src="https://upload-images.jianshu.io/upload_images/12890819-9b2c3a2844f82dbe.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240"
              style="max-width:100%;"
            ></a></p>
        <h3>3.7 空间复杂度分析</h3>
